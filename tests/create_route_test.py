...
class TestCreateRouteCommand(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.route = Route(datetime.now(), 'Sydney', 'Perth')
    ...
    def test_create_route_successful(self):
        ...
        params = ["2025-02-11-14:30", "New York", "Chicago", "Los Angeles"]
    ...
    def test_invalid_params_count(self):
        ...
        params = ["2025-02-11-14:30", "New York"]  # Missing next locations
        with self.assertRaises(ValueError):
            self.command.execute(params)
